      ...
      <div className="flex min-h-screen w-full bg-background text-foreground">
        <Sidebar variant="sidebar" className="border-r border-border/50">
          ...
          <SidebarContent className="px-4 py-2">
            <div className="mb-6">
              <h3 className="px-4 mb-2 text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/50">Menú Principal</h3>
              <SidebarMenu>
                {mainMenu.map((item) => (
                  <SidebarMenuItem key={item.name}>
                    <SidebarMenuButton asChild tooltip={item.name} className="h-11">
            ...
            <div>
              <h3 className="px-4 mb-2 text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/50">Sistema</h3>
              <SidebarMenu>
                {systemMenu.map((item) => (
                  <SidebarMenuItem key={item.name}>
                    <SidebarMenuButton asChild tooltip={item.name} className="h-11">
            ...
            <div className="flex items-center gap-6 flex-1 max-w-2xl">
              ...
              <div className="relative w-full group">
                ...
                <Input 
                  ...
                  className="pl-12 bg-muted/30 border-none h-11 rounded-xl focus-visible:ring-1 focus-visible:ring-primary/30 transition-all"
                />
              </div>
            </div>
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                <button className="relative p-2.5 rounded-xl hover:bg-muted/50 transition-colors text-muted-foreground">
                  <Bell className="h-5 w-5" />
                  <span className="absolute top-2 right-2 h-2.5 w-2.5 bg-primary border-2 border-background rounded-full" />
                </button>
                <button className="p-2.5 rounded-xl hover:bg-muted/50 transition-colors text-muted-foreground">
